...
/**
 * Qilin 3-callsite-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilin3CP1P2Test {
    ...
    @Test
    public void testPointsToQilin3CP1P2() {
        assertEquals(
                "Qilin 3-callsite-sensitive PTA should report NO_ALIAS for point1/point2, " +
