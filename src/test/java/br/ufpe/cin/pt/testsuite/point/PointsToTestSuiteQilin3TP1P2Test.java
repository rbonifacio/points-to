...
/**
 * Qilin 3-type-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilin3TP1P2Test {
    ...
    @Test
    public void testPointsToQilin3TP1P2() {
        assertEquals(
                "Qilin 3-type-sensitive PTA should report NO_ALIAS for point1/point2, " +
