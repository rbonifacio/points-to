...
/**
 * Qilin MAHJONG-guided 2-object-sensitive PTA for point2 vs point3 (alias: point3 = point2).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilinM2OP2P3Test {
    ...
    @Test
    public void testPointsToQilinM2OP2P3() {
        assertEquals(
                "Qilin MAHJONG-guided 2-object-sensitive PTA should report MAY_ALIAS for point2/point3, " +
