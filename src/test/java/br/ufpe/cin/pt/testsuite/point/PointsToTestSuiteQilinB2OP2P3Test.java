...
/**
 * Qilin BEAN-guided 2-object-sensitive PTA for point2 vs point3 (alias: point3 = point2).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilinB2OP2P3Test {
    ...
    @Test
    public void testPointsToQilinB2OP2P3() {
        assertEquals(
                "Qilin BEAN-guided 2-object-sensitive PTA should report MAY_ALIAS for point2/point3, " +
                ...
                new Driver().runAnalysis(config.setCallGraph(CallGraphAlgorithm.QILIN_B2O)));
    }
}
