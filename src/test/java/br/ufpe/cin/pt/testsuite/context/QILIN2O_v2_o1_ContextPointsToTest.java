 ...
 * does not alias {@code o1} when the two receiver objects are distinguished by 2-object sensitivity.
 */
public class QILIN2O_v2_o1_ContextPointsToTest {
    ...
    @Test
    public void testQilin2O_v2_o1_noAlias() {
        assertEquals(
                "Qilin 2-object-sensitive PTA should report NO_ALIAS for v2/o1 (v2 should only point to o2).",
                AliasTransformer.Result.PTA_NO_EVIDENCE_OF_ALIAS,
                new Driver().runAnalysis(config("v2", "o1").setCallGraph(CallGraphAlgorithm.QILIN_2O)));
    }
}
