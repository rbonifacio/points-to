...
/**
 * Qilin 3-hybrid-type-sensitive PTA on {@code br.ufpe.cin.pt.samples.context.Main#main(String[])}.
 *
 ...
 */
public class QILIN3HTContextPointsToTestSuite {
    ...
    @Test
    public void testQilin3HT_v1_v2_mayAlias() {
        assertEquals(
                "Qilin 3-hybrid-type-sensitive PTA should report MAY_ALIAS for v1/v2 (same receiver type B merges both calls).",
                AliasTransformer.Result.PTA_SUGGESTS_ALIAS,
                new Driver().runAnalysis(config("v1", "v2").setCallGraph(CallGraphAlgorithm.QILIN_3HT)));
    }
}
