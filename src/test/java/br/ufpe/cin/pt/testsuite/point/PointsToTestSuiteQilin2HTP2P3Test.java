...
/**
 * Qilin 2-hybrid-type-sensitive PTA for point2 vs point3 (alias: point3 = point2).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilin2HTP2P3Test {
    ...
    @Test
    public void testPointsToQilin2HTP2P3() {
        assertEquals(
                "Qilin 2-hybrid-type-sensitive PTA should report MAY_ALIAS for point2/point3, " +
                ...
                new Driver().runAnalysis(config.setCallGraph(CallGraphAlgorithm.QILIN_2HT)));
    }
}
