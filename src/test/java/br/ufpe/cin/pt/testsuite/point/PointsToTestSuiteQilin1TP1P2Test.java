...
/**
 * Qilin 1-type-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilin1TP1P2Test {
    ...
    @Test
    public void testPointsToQilin1TP1P2() {
        assertEquals(
                "Qilin 1-type-sensitive PTA should report NO_ALIAS for point1/point2, because point1 and point2 are created from different allocations (distinct Point objects).",
