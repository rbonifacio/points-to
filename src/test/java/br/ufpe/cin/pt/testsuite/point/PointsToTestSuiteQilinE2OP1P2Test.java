...
/**
 * Qilin EAGLE-guided 2-object-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilinE2OP1P2Test {
    ...
    @Test
    public void testPointsToQilinE2OP1P2() {
        assertEquals(
                "Qilin EAGLE-guided 2-object-sensitive PTA should report NO_ALIAS for point1/point2, " +
