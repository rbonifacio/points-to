...
/**
 * Qilin data-driven 2-callsite-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilinD2CP1P2Test {
    ...
    @Test
    public void testPointsToQilinD2CP1P2() {
        assertEquals(
                "Qilin data-driven 2-callsite-sensitive PTA should report NO_ALIAS for point1/point2, " +
