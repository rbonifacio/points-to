 ...
 * does not alias {@code o2} (the allocation site passed to the second call). Under 1-callsite
 * sensitivity the two calls are kept separate, so {@code v1} points only to {@code o1}.
 */
public class QILIN1C_v1_o2_ContextPointsToTest {
