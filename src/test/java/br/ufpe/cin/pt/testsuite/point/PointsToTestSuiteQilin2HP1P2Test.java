...
/**
 * Qilin 2-hybrid-object-sensitive PTA for point1 vs point2 (no alias).
 * Runs in a separate JVM so Qilin/Soot static state does not affect other Qilin tests.
 */
public class PointsToTestSuiteQilin2HP1P2Test {
    ...
    @Test
    public void testPointsToQilin2HP1P2() {
        assertEquals(
                "Qilin 2-hybrid-object-sensitive PTA should report NO_ALIAS for point1/point2, " +
